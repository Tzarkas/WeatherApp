package com.example.corp.sunshine;

/**
 * Created by tzarkas on 26/07/14.
 */
...
public  class ForecastFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ListView viewForecast =(ListView ) rootView.findViewById(R.id.listview_forecast);
        viewForecast.setAdapter(adapter);
